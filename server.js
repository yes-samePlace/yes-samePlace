...
var re = new RegExp(req.params.term,"i");
  ...
  Places.findOne({"user_search":re},{map1:"",map2:"",wiki1:"",wiki2:"",_id:0},function(err, doc) { //.exec
  	console.log("New msm re: ",re)
    if (err) {
      console.log("Try something else");
    }
    else if (doc) {
    	//for(var i = 0; i < doc.length; i++) {
    		console.log("map1 ", doc.map1);
     		res.send(doc);
     		
     	//}
    } else {
      console.log("Nothing matches in the database.");
    }
  });
});
