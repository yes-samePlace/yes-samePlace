...
var helpers = {
  ...
  runQuery: function(searchTerm,map) {

    console.log(searchTerm);

      axios.get("/api/search/" + searchTerm).then(function(res) {
        console.log("res.map1 is " + JSON.stringify(res.data.map1));
        var location = res.data.map1; //JSON.stringify()
